...
- Toda classe tem uma **interface pública**: conjunto de métodos
  que devem ser chamados pelos seus objetos
...
Python não funciona desta forma. Mais sobre isto no
notebook da aula. 
---
...
- _Métodos_: O estacionamento pode registrar uma entrada e uma saída de um carro.
             Além disso, o estacionamento deve fornecer para usuários da classe
...
`Estacionamento`. Esta consistência pode ser mantida com modificações diretas?
