...
- Atendimento:
    ...
    - Via [Discord](https://discord.gg/fCBhRHvpAp)
...
São estas as duas perguntas que cada um de vocês deverá
responder ao final do semestre
...
- Entretanto: é necessário escolher uma linguagem para colocar os
...
- IDES:
    - Mais simples: [Sublime](https://www.sublimetext.com/)/
    [Atom](https://atom.io/) 
    - Mais completas: [Visual Studio Code](https://code.visualstudio.com/)/
...
- Livros:
    - [Learning Python](https://www.amazon.com.br/dp/B00DDZPC9S/ref=dp-kindle-redirect?_encoding=UTF8&btkr=1)
